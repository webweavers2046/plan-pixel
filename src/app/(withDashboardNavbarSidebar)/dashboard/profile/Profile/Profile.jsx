                ...
                <div className="flex justify-between">
                    <div className="flex items-end">
                        <Image
                            ...
                            width={200}
                            height={200}
                            className="lg:w-48 lg:h-48 md:w-40 md:h-40 w-32 h-32 rounded-lg object-cover"
                        />
                        <div className="p-5">
                            <h4 className="lg:text-3xl text-xl font-semibold">{userData?.name}</h4>
                            <p className="lg:text-sm text-[10px] mt-1 font-semibold text-[#00000080]">{userData?.email}</p>
                        </div>
                    </div>
                    <div>
                        {
                ...
                <div className="mt-9">
                    ...
                    <div className="p-3 mt-1 w-full">
                        ...
                        <div className="flex md:gap-6 gap-3">
                            {
                                socialLinks?.map(link => <div key={link?.platform} className="flex gap-1">
                                    <p className="lg:text-lg text-sm">{link?.platform}</p>
