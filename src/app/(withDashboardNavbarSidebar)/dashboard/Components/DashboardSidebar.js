  ...
  return (
    <div className="sticky top-0">
      <div className="relative">
        <div className={`mr-2 h-screen xl:block hidden border-r-2 relative `}>
                ...
                <div>
                  <ul>
                    <li>
                      <Link
                        className={`flex items-center  gap-x-4 ${
                          pathname == "/admin-dashboard" ? "active" : "inactive"
                    ...
                    <li>
                      <Link
                        className={`flex items-center  gap-x-4 ${
                          pathname == "/admin-dashboard/premium-members"
                            ? "active"
                            : "inactive"
                        }  px-4 py-3 rounded-md cursor-pointer font-semibold`}
                ...
                <div>
                  <ul className="space-y-2">
                    ...
                    <li>
                      <Link
                        className={`flex items-center  gap-x-4 ${
                          pathname == "/dashboard/tasks" ? "active" : "inactive"
                        }  px-4 py-3 rounded-md cursor-pointer font-semibold`}
