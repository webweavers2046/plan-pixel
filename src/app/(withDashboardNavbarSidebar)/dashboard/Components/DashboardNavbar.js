...
const DashboardNavbar = ({ openDashboard, setOpenDashboard }) => {
  return (
    <div className="flex justify-between items-center p-4">
      <button
        className=" flex lg:hidden mr-1 font-bold text-2xl text-primary rounded-full"
        onClick={() => setOpenDashboard(!openDashboard)}>
        <TbMenu />
      </button>
      <div>
        <select className="w-[250px] text-center ">
