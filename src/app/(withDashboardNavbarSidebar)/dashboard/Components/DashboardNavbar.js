  ...
  return (
    <div className="flex justify-between items-center p-4">
      <div>
        <button
          type="button"
          className="btn px-4 py-2 rounded-sm hover:bg-gray-200 transition-all duration-300 flex items-center gap-x-1"
        >
          Workspaces{" "}
          <RiArrowDropDownLine className="text-3xl flex items-center" />
        </button>
        ...
        <div className="dropdown ">
          ...
          <ul>
            <li>Ring of Fire</li>
            <li>Shuffle the Square</li>
            <li>Sajid's Workspaces</li>
          </ul>
        </div>
        {/* <h1>Workspaces</h1> */}
      </div>
