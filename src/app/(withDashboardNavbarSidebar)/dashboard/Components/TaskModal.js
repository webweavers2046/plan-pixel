                ...
                <form onSubmit={handleSubmit(onSubmit)} className=" mt-8 px-4">
                    ...
                    <div className=" grid grid-cols-2 gap-5">
                        ...
                        <div className=''>
                            ...
                            <input type="text" placeholder='Title'   {...register("title", { required: true })} name="title" className='py-3 pl-4 w-full border border-gray-300 mt-3 rounded-md' id="" />
                            {errors.title && <span className='text-red-500'>This field is required</span>}
                        </div>
                        {/* Priority */}
                        <div className=''>
                            <h4 className='text-lg font-semibold'>Priority</h4>
                            <select placeholder='Select' name="priority" className='py-3 pl-4 w-full border border-gray-300 mt-3 rounded-md' {...register("priority", { required: true })} >
                        ...
                        <div className=''>
                            ...
                            <input type="date" {...register("startDate", { required: true })} name="startDate" className='py-3 pl-4 w-full border border-gray-300 mt-3 rounded-md' id="" />
                            {errors.startDate && <span className='text-red-500'>This field is required</span>}
                        </div>
                        {/* Due Date */}
                        <div className=''>
                            <h4 className='text-lg font-semibold'>Due Date</h4>
                            <input type="date" {...register("dueDate", { required: true })} name="dueDate" className='py-3 pl-4 w-full border border-gray-300 mt-3 rounded-md' id="" />
                            {errors.dueDate && <span className='text-red-500'>This field is required</span>}
                        </div>
                        {/* Description */}
                        <div className=''>
                            <h4 className='text-lg font-semibold'>Description</h4>
                            <textarea type="text" {...register("description", { required: true })} name="description" placeholder='Description' className='py-3 pl-4 w-full border border-gray-300 mt-3 rounded-md' id="" />
                    ...
                    <div className="flex justify-end items-end ">
                        <button className="bg-[#50B577] p-4 text-white rounded-lg">Add New Task</button>
                    </div>
                </form>
            </div>
        </div>
