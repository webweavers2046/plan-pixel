...
const taskManagementArray = [
    {
        id: 2,
        text: "Experience Effortless Task Management with our Intuitive Interface.",
    },
    { id: 3, text: "Seamlessly Organize Your Tasks for Enhanced Productivity" },
    {
        id: 4,
        text: "Unlock Efficiency with our Streamlined Task Creation Process",
    },
];
...
const collaborationArray = [
    {
        id: 6,
        text: "Enhance Team Collaboration with Instant Communication Features.",
    },
    {
        id: 7,
        text: "Create an Instant Communication Hub for Seamless Teamwork.",
    },
    {
        id: 8,
        text: "Achieve Real-Time Collaboration for Increased Project Efficiency.",
    },
];
...
export const customizationArray = [
    {
        id: 10,
        text: "Tailor Workflows to Fit Your Project's Unique Requirements.",
    },
    {
        id: 11,
        text: "Flexible Project Management Boards for Your Changing Needs.",
    },
