    ...
    <div className={` ${isCreateWokspace ? "visible opacity-100" : "invisible opacity-0"} transition-all duration-300`}>
      <>
        <div className="flex items-center ">
          <div className="bg-white shadow-lg h-[225px] rounded-sm p-4 z-40 absolute left-[270px] w-[255px] overflow-hidden top-28 mx-auto">
            ...
            <div className="flex relative gap-2 justify-between pt-3">
              <button
                // type="button"
                onClick={handleClose}
                className="rounded-lg w-1/2 active:scale-90 transition-transform duration-300 z-50 cursor-pointer flex items-center justify-center bg-[#f6f6f6] p-3 text-primary shadow-sm"
              >
                <IoIosCloseCircleOutline className="text-[24px] cursor-pointer text-red-500" />
              </button>
              <button
                onClick={handleSubmit}
                className="rounded-lg w-1/2 active:scale-90 transition-transform duration-300 p-3 flex z-20 items-center justify-center bg-[#f6f6f6] text-primary shadow-sm"
              >
